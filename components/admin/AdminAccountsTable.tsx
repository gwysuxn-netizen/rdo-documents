...
import { UserRecord, deleteUserRecord, updateUserRecord } from '@/lib/user-utils';
...
function EditModal({ account, onClose, onSaved }: { account: UserRecord; onClose: () => void; onSaved: () => void }) {
  // Fix: default office to '' so the input is always controlled
...
export function AdminAccountsTable({ accounts, currentUserEmail, onUpdate }: AdminAccountsTableProps) {
